(function (jz) {
    ...
    jz.msg = function (obj) {
        ...
        //拖动
        if (obj.drag) { if (obj.title != undefined) { jz.drag(msg, top); } else { jz.drag(msg) } }
        //动态居中
        jz.art.center(msg);
